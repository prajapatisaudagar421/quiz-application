...
import static com.example.college_project.SplashScreen.list5;
...
public class DashboardActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ic_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DashboardActivity5.this,CategoryActivity.class);
                startActivity(intent);
            }
        });

        Hooks();
        allQuestionList = list5;
        Collections.shuffle(allQuestionList);
        modelclass = list5.get(index);
        ...
        countDownTimer = new CountDownTimer(10000,1000) {
            ...
            public void onFinish() {
                Dialog dialog = new Dialog(DashboardActivity5.this,R.style.Dailoge);
    ...
    private void GameWon() {
        Intent intent = new Intent(DashboardActivity5.this,WonActivity.class);
