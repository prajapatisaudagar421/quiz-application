...
import static com.example.college_project.SplashScreen.list3;
...
public class DashboardActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ic_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DashboardActivity3.this,CategoryActivity.class);
                startActivity(intent);
            }
        });

        Hooks();
        allQuestionList = list3;
        Collections.shuffle(allQuestionList);
        modelclass = list3.get(index);
        ...
        countDownTimer = new CountDownTimer(10000,1000) {
            ...
            public void onFinish() {
                Dialog dialog = new Dialog(DashboardActivity3.this,R.style.Dailoge);
    ...
    private void GameWon() {
        Intent intent = new Intent(DashboardActivity3.this,WonActivity.class);
