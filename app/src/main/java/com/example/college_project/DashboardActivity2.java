...
import static com.example.college_project.SplashScreen.list2;
...
public class DashboardActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ic_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DashboardActivity2.this,CategoryActivity.class);
                startActivity(intent);
            }
        });

        Hooks();
        allQuestionList = list2;
        Collections.shuffle(allQuestionList);
        modelclass = list2.get(index);
        ...
        countDownTimer = new CountDownTimer(10000,1000) {
            ...
            public void onFinish() {
                Dialog dialog = new Dialog(DashboardActivity2.this,R.style.Dailoge);
    ...
    private void GameWon() {
        Intent intent = new Intent(DashboardActivity2.this,WonActivity.class);
