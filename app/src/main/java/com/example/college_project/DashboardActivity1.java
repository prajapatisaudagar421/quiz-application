...
public class DashboardActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ic_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DashboardActivity1.this,CategoryActivity.class);
                startActivity(intent);
            }
        });

        Hooks();
        allQuestionList = list1;
        Collections.shuffle(allQuestionList);
        modelclass = list1.get(index);
        ...
        countDownTimer = new CountDownTimer(10000,1000) {
            ...
            public void onFinish() {
                Dialog dialog = new Dialog(DashboardActivity1.this,R.style.Dailoge);
    ...
    private void GameWon() {
        Intent intent = new Intent(DashboardActivity1.this,WonActivity.class);
